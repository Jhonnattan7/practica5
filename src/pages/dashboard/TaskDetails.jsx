    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className={`rounded-lg shadow-md p-6 ${theme === 'dark' ? 'bg-gray-800' : 'bg-white'}`}>
        ...
        <div className="border-t dark:border-gray-700 pt-6">
          <h2 className="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-2">Descripción</h2>
        ...
        <div className="border-t dark:border-gray-700 pt-6 mt-6">
          <h2 className="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-4">Información adicional</h2>
          <dl className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Creada</dt>
              <dd className="text-gray-900 dark:text-gray-100">{formatDateTime(task.createdAt)}</dd>
            </div>
            
            {task.dueDate && (
              <div>
                <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Fecha de vencimiento</dt>
                <dd className="text-gray-900 dark:text-gray-100">{formatDateTime(task.dueDate)}</dd>
              </div>
            )}
          </dl>
        </div>
